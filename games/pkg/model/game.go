...
type Game struct {
	...
	ID header.GameID `json:"id,omitempty" example:"1234" doc:"The unique identifier for the game, generated by the service"`
	...
	Status GameState `json:"status,omitempty" example:"1" doc:"The current state of the game, indicating whether it is scheduled, in progress, completed etc."`
}
